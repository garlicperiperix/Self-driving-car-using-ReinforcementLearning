...
class RacingEnv:
    ...
    def render(self, action):
        ...
        #print('coordinates= ', self.screen.blit(self.back_image, self.back_rect))
        ...
        #render controll
        pygame.draw.rect(self.screen,(255,0,0),(800, 100, 40, 40),2)
        pygame.draw.rect(self.screen,(255,0,0),(850, 100, 40, 40),2)
        pygame.draw.rect(self.screen,(255,0,0),(900, 100, 40, 40),2)
        pygame.draw.rect(self.screen,(255,0,0),(850, 50, 40, 40),2)
